...
public class Runner_Demo13_DeadLock {

	public Runner_Demo13_DeadLock() {
		// TODO Auto-generated constructor stub
	}

	private AccountDemo13DeadLock acc1 = new AccountDemo13DeadLock();
    private AccountDemo13DeadLock acc2 = new AccountDemo13DeadLock();
    ...
    public void firstThread() throws InterruptedException {
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            try {
            	AccountDemo13DeadLock.transfer(acc1, acc2, random.nextInt(100));
            } finally {
                lock1.unlock();
                lock2.unlock();
            }
    ...
    public void secondThread() throws InterruptedException {
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            try {
            	AccountDemo13DeadLock.transfer(acc2, acc1, random.nextInt(100));
            } finally {
                lock1.unlock();
                lock2.unlock();
            }
